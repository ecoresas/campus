...
Gem::Specification.new do |s|
  ...
  s.files = ["ChangeLog", "HACKING", "ISSUES", "LATEST", "LICENSE", "NEWS", "README", "TODO", "ext/kgio/accept.c", "ext/kgio/autopush.c", "ext/kgio/connect.c", "ext/kgio/extconf.rb", "ext/kgio/kgio_ext.c", "ext/kgio/poll.c", "ext/kgio/read_write.c", "ext/kgio/tryopen.c", "ext/kgio/wait.c", "lib/kgio.rb"]
